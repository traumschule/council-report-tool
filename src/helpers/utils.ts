...
export const plural = (quantity?: unknown, suffix = "s") =>
  quantity === 1 ? "" : suffix;

export const cutText = (text: string, length = 100) =>
  ...
  switch (value) {
    case "Operations Alpha":
      return {
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/builders",
      };
    case "Storage":
      return {
        subtitle:
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/storage",
      };
    case "Content":
      return {
        subtitle:
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/content-directory",
      };
    case "Distribution":
      return {
        subtitle:
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/storage#distributor",
      };
    case "App":
      return {
        subtitle:
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/gateways",
      };
    case "Operations Beta":
      return {
        subtitle:
    ...
    case "Operations Gamma":
      return {
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/marketers",
      };
    case "Membership":
      return {
        subtitle:
    ...
    case "Forum":
      return {
        ...
        tooltipLink:
          "https://joystream.gitbook.io/testnet-workspace/system/forum",
      };
    default:
      return {
        subtitle: value,
...
export const decimalAdjust = (value: number): number => {
...
export const uploadImage = async (imgData: string): Promise<string> => {
  ...
  if (content.success) return content.data.link;
  else return "";
};
